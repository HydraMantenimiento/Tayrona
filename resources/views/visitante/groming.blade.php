                    ...
                    <div class="service-details">
                        <div class="inner-box">
                            <div class="content-style-one">
                                <figure class="image-box"><img src="{{asset('imagenes/spa.jpg')}}" alt=""></figure>
                                <h2>Chequeos de aseo regulares</h2>
                                <div class="text">
                        ...
                        <div class="sidebar-category sidebar-widget gray-bg wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms" style="visibility: visible;">
                            ...
                            <div class="widget-content">
                                <ul class="category-list">
                                    <li class="active">PELUQUERIA</li>
                                    <li >SPA</li>
                                    <li>CORTE &amp; BAÑO COMPLETO</li> <!--&amp;  -->
                                    <li>MASAJES CORPORALES</li>
                                    <li>BAÑO HIPOALERGENICO</li>
                                    <li>AROMATERAPIA</li>
