                ...
                @foreach($blogs as $blog)
                    <div class="col-lg-4 col-md-6 col-sm-12 news-column">
                        <div class="news-block-one wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                            ...
                            <figure class="image-box"><a href="{{ route('blogview', $blog->id) }}"><img src="{{ asset($blog->imagen) }}" alt="" style="height: 387px; width:370px;"></a></figure>
                            <div class="lower-content">
                                <ul class="info-box"></ul>
                                <h3><a href="{{ route('blogview', $blog->id) }}">{{ $blog->title}}</a></h3>
                                <div class="link"><a href="{{ route('blogview', $blog->id) }}">Read more</a></div>
                            </div>
                        </div>
                    </div>
                @endforeach
